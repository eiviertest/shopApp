                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input v-model="usuario" type="text" maxlength="50" class="form-control" placeholder="Nombre de Usuario">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="password-input">Password (*)</label>
                                <div class="col-md-9">
                                    <input v-model="password" type="password" maxlength="18" minlength="7" class="form-control" placeholder="Password de Acceso">
                                </div>
                            </div>
...
<script>
    ...
    methods:{
        ...
        validarPersona(){
            ...
            } else if([null, undefined, ''].includes(this.usuario)){
                this.errorMostrarMsjPersona.push("El usuario no puede estar vacío.");
            } else if([null, undefined, ''].includes(this.password)){
                this.errorMostrarMsjPersona.push("La contraseña no puede estar vacía.");
            } else if([null, undefined, 0].includes(this.idrol) || this.idrol < 0){
